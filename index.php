...
<body>
    ...
    <div>
        <ul>
            ...
            <li><a href="temario.html" target="contenedor1">Temario de Pro Web</a></li>
        </ul>
    </div>
    <div id="contenedor1">
        <p>
        ...
        <iframe name="contenedor1" width="100%" height="600px" frameborder="0"></iframe>
        <?php
         if (isset($_REQUEST['opcion'])){
            if ($_REQUEST['opcion'] == "Multimedia"){
